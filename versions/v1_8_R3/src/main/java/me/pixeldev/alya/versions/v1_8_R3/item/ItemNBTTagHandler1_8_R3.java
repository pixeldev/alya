package me.pixeldev.alya.versions.v1_8_R3.item;
...
public class ItemNBTTagHandler1_8_R3 implements ItemNBTTagHandler {
	@Override
	...
	public ItemStack setTags(ItemStack source, Map<String, String> nbtTags) {
		net.minecraft.server.v1_8_R3.ItemStack itemStack = asNmsItem(source);
	...
	private static net.minecraft.server.v1_8_R3.ItemStack asNmsItem(ItemStack source) {
		return CraftItemStack.asNMSCopy(source);
	}

	private static NBTTagCompound getTagCompound(net.minecraft.server.v1_8_R3.ItemStack source) {
